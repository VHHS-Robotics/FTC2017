...
@Autonomous(name = "Robot2_RedSpot1_NoEncoder", group = "Linear Opmode")
public class Robot2_Red_Spot1_NoEncoder extends LinearOpMode {
    ...
    public static double targetHeading = 70.00;
...
//        SmallRelicServo.setPosition(0.5);
        ...
        while (opModeIsActive() && (runtime.seconds() < 30.0)) {
            ...
            if (runtime.seconds() > 3.0 && runtime.seconds() < 7.5) {
                ...
                while (currentHeading > targetHeading || currentHeading == 0 || currentHeading == 1 || currentHeading == 2 || currentHeading == 3 || currentHeading == 4 || currentHeading == 5) {
            ...
            if (runtime.seconds() > 7.5  && runtime.seconds() < 8.5) { // following the white line
                stopRobot();
            }

            if (runtime.seconds() > 8.5  && runtime.seconds() < 11.75) { // following the white line
                goStraight(.425);
            }
            if (runtime.seconds() > 11.75  && runtime.seconds() < 12.75) { // following the white line
                stopRobot();
            }
            if (runtime.seconds() > 12.75  && runtime.seconds() < 13.25) { // following the white line
                GlyphServoRight.setPosition(1.0);
                GlyphServoLeft.setPosition(0.0);
            }
            if (runtime.seconds() > 13.25  && runtime.seconds() < 13.75) { // following the white line
                goBack(.3);
            }
            if (runtime.seconds() > 13.75  && runtime.seconds() < 14.25) { // following the white line
                GlyphServoRight.setPosition(0.5);
                GlyphServoLeft.setPosition(0.5);
            }
            if (runtime.seconds() > 14.25  && runtime.seconds() < 14.75) { // following the white line
                goStraight(.5);
            }
            if (runtime.seconds() > 14.75  && runtime.seconds() < 15.25) { // following the white line
                goRight(.2);
            }
            if (runtime.seconds() > 15.25  && runtime.seconds() < 15.75) { // following the white line
                goBack(.3);
            }
            if (runtime.seconds() > 15.75  && runtime.seconds() < 30.00) { // following the white line
                stopRobot();
            }
