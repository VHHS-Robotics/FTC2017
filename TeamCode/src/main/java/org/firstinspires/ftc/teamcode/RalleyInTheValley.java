...
@Autonomous(name = "RallyInTheValley", group = "Linear Opmode")
public class RalleyInTheValley extends LinearOpMode {
...
//        SmallRelicServo = hardwareMap.servo.get("servo2");
        ...
        while (opModeIsActive() && (runtime.seconds() < 65.0)) {
            ...
            if (runtime.seconds() > 0.5 && runtime.seconds() < 1.00){ //algo to decide which ball to knock off
                JewelServo.setPosition(0.68);            }
            if (runtime.seconds() > 1.00 && runtime.seconds() <2.00) {
                encoderDrive(0.6, 24.0, 24.0, 2.0); // left 4sec
                sleep(100);
            }
            if (runtime.seconds() > 2.0 && runtime.seconds() < 4.0) {
            ...
            if (runtime.seconds() > 4.00  && runtime.seconds() < 8.00) { //All of them off by +3 in?
                encoderDrive(0.6, 72.0, 72.0, 6.00); // left 4sec
                sleep(100);
            }
            if (runtime.seconds() > 8.00 && runtime.seconds() < 10.00) {

                double targetHeading = 170.00;
...
//            if (runtime.seconds() > 12.0  && runtime.seconds() < 17.0) {
//                encoderDrive(0.6, 36.0, 36.0, 13.5); // left 4sec
//                sleep(100);
//            }
//            if (runtime.seconds() > 17.0  && runtime.seconds() < 20.0) { // following the white line
//                double targetHeading = 315.00;
//
//                double currentHeading = GyroSensor.getHeading();
//                double leftSpeed, rightSpeed;
//
...
//                stopRobot();
//            }
//            if (runtime.seconds() > 20.0  && runtime.seconds() < 22.0) { // following the white line
//                encoderDrive(0.6, 22, 22, 20.0);
//                sleep(100);
//            }
//            if (runtime.seconds() > 22.0  && runtime.seconds() < 26.0) { // following the white line
//                double targetHeading = 135.00;
//
//                double currentHeading = GyroSensor.getHeading();
//                double leftSpeed, rightSpeed;
//
...
//                stopRobot();
//            }
//            if (runtime.seconds() > 26.0  && runtime.seconds() < 28.0) {
//                encoderDrive(0.6, 12, 12, 28.0);
//                sleep(100);
//            }
//            if (runtime.seconds() > 28.0  && runtime.seconds() < 30.0) {
//                encoderDrive(0.6, -12, -12, 30.0);
//            }
//            if (runtime.seconds() > 30.0  && runtime.seconds() < 34.0) {
//                double targetHeading = 315.00;
//
//                double currentHeading = GyroSensor.getHeading();
//                double leftSpeed, rightSpeed;
...
//                stopRobot();
//            }
//            if (runtime.seconds() > 34.0  && runtime.seconds() < 35.0) { // following the white line
